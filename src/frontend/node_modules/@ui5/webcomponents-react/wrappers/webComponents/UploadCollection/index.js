 ...
 */
const UploadCollection = withWebComponent('ui5-upload-collection', ['accessibleName', 'noDataDescription', 'noDataText', 'selectionMode'], ['hideDragOverlay'], ['header'], ['item-delete', 'selection-change']);
