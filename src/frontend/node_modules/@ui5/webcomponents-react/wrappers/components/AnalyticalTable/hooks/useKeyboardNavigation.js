...
const useGetTableProps = (tableProps, {
  ...
  const onTableFocus = useCallback(e => {
    ...
    if (dataset.emptyRowCell === 'true' || Object.prototype.hasOwnProperty.call(dataset, 'subcomponentActiveElement') ||
    // todo: with the new popover API of ui5wc this might not be necessary anymore
    dataset.componentName === 'ATHeaderPopoverList' || dataset.componentName === 'ATHeaderPopover' || dataset.componentName === 'AnalyticalTableNoDataContainer') {
      return;
    }
