...
import { COLLAPSE_NODE, COLLAPSE_PRESS_SPACE, DESELECT_ALL, EXPAND_NODE, EXPAND_PRESS_SPACE, FILTERED, GROUPED, INVALID_TABLE, LIST_NO_DATA, NO_DATA_FILTERED, PLEASE_WAIT, ROW_COLLAPSED, ROW_EXPANDED, SELECT_ALL, SELECT_ALL_PRESS_SPACE, SELECT_PRESS_SPACE, UNSELECT_ALL_PRESS_SPACE, UNSELECT_PRESS_SPACE } from '../../i18n/i18n-defaults.js';
...
const AnalyticalTable = /*#__PURE__*/forwardRef((props, ref) => {
  ...
  const tableClasses = clsx(classNames.table, withNavigationHighlight && classNames.hasNavigationIndicator, showVerticalEndBorder && classNames.showVerticalEndBorder, nativeScrollbar ? 'ui5-content-native-scrollbars' : `ui5-content-native-scrollbars ${classNames.analyticalTableDelta}`);
  ...
  return /*#__PURE__*/_jsxs(_Fragment, {
    children: [/*#__PURE__*/_jsxs("div", {
      ...
      children: [header && /*#__PURE__*/_jsx(TitleBar, {
        ...
        }), (additionalEmptyRowsCount || tableState.isScrollable) && /*#__PURE__*/_jsx(VerticalScrollbar, {
          tableBodyHeight: tableBodyHeight,
